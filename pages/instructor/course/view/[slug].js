...
const CourseView = () => {
    ...
    const handlePublish = async (e, courseId) => {
        ...
        try {
            let answer = window.confirm(
                "Once you publish your course, it will be live in marketplace for users to enroll."
            );
            if (!answer) return;
    ...
    const handleUnpublish = async (e, courseId) => {
        try {
            ...
            setCourse(data)
            toast("Your course is now unpublished and won't be available in marketplace.")            
        } catch (err) {
    ...
    return (
        <InstructorRoute>
            <div className="container-fluid pt-3">
                ...
                {course &&
                    <div className="container-fluid pt-1 border">
