...
const CourseEdit = () => {
    ...
    const handleDrop = async (e, index) => {
        ...
        let movingItem = allLessons[movingItemIndex]; //clicked or dragged item to re-order
    ...
    const handleDelete = async (index) => {
        // console.log("delete lesson", index)
        // return;
    ...
    const handleVideo = async (e) => {
        ...
        if (current.video && current.video.Location) {
            const res = 
                await axios.post(`/api/course/video-remove/${values.instructor._id}`,
                current.video
            );
